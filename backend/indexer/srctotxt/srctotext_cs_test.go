...
func TestCSGetFunction(t *testing.T) {
    ...
    if slice[0] != "public int Add(int x, int y)" {
        t.Errorf("TestCSGetFunction failed want %q got %v", "public int Add(int x, int y)", slice[0])
    }
}
...
func TestCSGetMultipleFunction(t *testing.T) {
    ...
    if !slices.Contains(slice, "public string Add(string x, int y)") {
        t.Errorf("TestCSGetMultipleFunction failed want %q got %v", "public string Add(string x, int y)", slice)
    }
    if len(slice) != 2 {
...
func TestCSGetEmptyFunction(t *testing.T) {
    ...
    if !slices.Contains(slice, "public void Test()") {
        t.Errorf("TestCSGetEmptyFunction failed want %q got %v", "public void Test()", slice)
    }
}
...
func TestCSGetNestedFunction(t *testing.T) {
    ...
    if !slices.Contains(slice, "void Nested2(int y)") {
        t.Errorf("TestCSGetNestedFunction failed want %q got %v", "void Nested2(int y)", slice)
    }
    if len(slice) != 2 {
...
func TestCSGetMultipleFunctionSignature(t *testing.T) {
    ...
    if !slices.Contains(slice, "string int string") {
        t.Errorf("TestCSGetMultipleFunctionSignature failed want %q got %v", "string int string", slice)
    }
    if len(slice) != 2 {
...
func TestCSGetEmptyFunctionSignature(t *testing.T) {
    ...
    if !slices.Contains(slice, "void") {
        t.Errorf("TestCSGetEmptyFunctionSignature failed want %q got %v", "void", slice)
    }
}
...
<param name="y">Another integer.</param>
<returns>The sum of x and y.</returns>*/`) {
        t.Errorf("TestCSGetDocs failed want %q got %v", "/// <summary> Adds two numbers...", slice)
    }
    if len(slice) != 1 {
...
/// <param name="x">An integer.</param>
/// <param name="y">Another integer.</param>` ){
        t.Errorf("TestCSGetLineDocs failed want %q got %v", "/// Adds two numbers...", slice)
    }
    if len(slice) != 1 {
...
/// <param name="x">An integer.</param>
/// <param name="y">Another integer.</param>` ){
        t.Errorf("TestCSGetMultipleDocs failed want %q got %v", "/// Adds two numbers...", slice)
    }
    if !slices.Contains(slice, `/// Subtracts two numbers.
/// <param name="x">An integer.</param>/// <param name="y">Another integer.</param>`) {
        t.Errorf("TestCSGetMultipleDocs failed want %q got %v", "/// Subtracts two numbers...", slice)
    }
    if len(slice) != 2 {
