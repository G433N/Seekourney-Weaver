...
func Default() ExtensionMap {
	return ExtensionMap{
		...
		functionDeclaration: []string{"function_declaration", "func_literal", "method_declaration"},
		...
		".ts": {
			...
			functionDeclaration: []string{"function_declaration", "method_definition"},
			classDeclaration: []string{"class_declaration"},
			rightSideTypeParam: true,
			rightSideReturn: true,
			receiver: "",
			returnType: []string{"formal_parameters", "type_annotation"},
			blockComment: "comment",
			lineComment: "comment",
		},
		".cs": {
			...
			receiver: "",
			returnType: []string{"identifier", "generic_name", "predefined_type", "variable_declaration"},
			blockComment: "comment",
			lineComment: "comment",
		},
		".rs": {
			...
			returnType: []string{"generic_type", "primitive_type", "identifier", "reference_type", "where_clause"},
