...
func TestRSGetMultipleFunction(t *testing.T) {
    ...
    if !slices.Contains(slice, "fn add(x: String, y: i32) -> String") {
        t.Errorf("TestRSGetMultipleFunction failed want %q got %v", "fn add(x: String, y: i32) -> String", slice)
    }
    if len(slice) != 2 {
...
func TestRSGetEmptyFunction(t *testing.T) {
    ...
    if !slices.Contains(slice, "fn test()") {
        t.Errorf("TestRSGetEmptyFunction failed want %q got %v", "fn test()", slice)
    }
}
...
func TestRSGetNestedFunction(t *testing.T) {
    ...
    if !slices.Contains(slice, "fn nested2(y: i32) -> i32") {
        t.Errorf("TestRSGetNestedFunction failed want %q got %v", "fn nested2(y: i32) -> i32", slice)
    }
    if len(slice) != 2 {
...
func TestRSGetMultipleFunctionSignature(t *testing.T) {
    ...
    if !slices.Contains(slice, "String i32 String") {
        t.Errorf("TestRSGetMultipleFunctionSignature failed want %q got %v", "String i32 String", slice)
    }
    if len(slice) != 2 {
...
func TestRSGetEmptyFunctionSignature(t *testing.T) {
    ...
    if !slices.Contains(slice, "void") {
        t.Errorf("TestRSGetEmptyFunctionSignature failed want %q got %v", "void", slice)
    }
}
...
func TestRSGetNestedFunctionSignature(t *testing.T) {
    ...
    if !slices.Contains(slice, "i32 String") {
        t.Errorf("TestRSGetNestedFunctionSignature failed want %q got %v", "i32 String", slice)
    }
    if len(slice) != 3 {
...
The sum of x and y.
*/`) {
        t.Errorf("TestRSGetDocs failed want %q got %v", "/* Adds two numbers...", slice)
    }
    if len(slice) != 1 {
...
/// * y - Another integer.
` {
        t.Errorf("TestRSGetLineDocs failed want %q got %v", "/// Adds two numbers...", slice)
    }
    if len(slice) != 1 {
...
/// * y - Another integer.
`) {
        t.Errorf("TestRSGetMultipleDocs failed want %q got %v", "/// Adds two numbers...", slice)
    }
...
/// * y - Another integer.
`) {
        t.Errorf("TestRSGetMultipleDocs failed want %q got %v", "/// Subtracts two numbers...", slice)
    }
    if len(slice) != 2 {
